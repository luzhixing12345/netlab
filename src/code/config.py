...
ADJUST_RTT_THRESHOLD = 1000 # 超过 RTT 的次数阈值
...
SYN_ACK_PATTERN = re.compile(r"SYN ACK (?P<filesize>\d+) (?P<max_package_count>\d+)")
# SYN_ACK_PATTERN = 'ACK'
